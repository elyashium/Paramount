...
import { Mail, Lock, LogIn, Anchor } from 'lucide-react'
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 relative overflow-hidden">
        ...
        {/* Anchor watermark */}
        <div className="absolute right-[-3rem] bottom-[-3rem] text-[20rem] opacity-[0.04] select-none pointer-events-none leading-none">⚓</div>
        ...
        <div className="relative z-10">
          <motion.h1
            ...
            className="text-5xl font-black text-white leading-tight mb-5"
          >
            Navigate your{' '}
          ...
          >
            India&apos;s premier IMU-CET coaching. Join 50,000+ cadets already on their journey to sea.
          </motion.p>
        </div>
        ...
        >
          {[['50K+', 'Students'], ['95%', 'Success Rate'], ['8+', 'Years']].map(([val, lbl]) => (
            <div key={lbl} className="border border-white/10 rounded-xl p-4 text-center">
              <div className="text-2xl font-black text-[#E8B84B]">{val}</div>
      ...
      {/* ── RIGHT PANEL — form ────────────────────────────────────────── */}
      <div className="flex-1 flex items-center justify-center px-6 py-8 bg-[#0d0d0d] lg:bg-black/40">
        <motion.div
        ...
        >
          ...
          <p className="text-sm text-gray-500 mb-7">Sign in to your Paramount account</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-[#E8B84B]/60 focus:ring-[#E8B84B]/20 h-11"
                  required
                />
              </div>
            </div>
          ...
          <Button
            ...
            className="w-full h-11 font-semibold text-sm border-white/10 bg-white/5 text-gray-300 hover:bg-white/10 hover:text-white rounded-xl"
          >
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/auth/signup" className="text-[#E8B84B] hover:text-[#c9922a] font-semibold transition-colors">Sign up</Link>
          </p>
        </motion.div>
      </div>
    </div>
