...
export default async function AdminLayout({
    ...
    return (
        <div className="flex min-h-screen bg-[#0a0a0a] text-white pt-20">
            {/* Sidebar - Not Fixed */}
            <aside className="w-64 border-r border-white/10 bg-black/40 backdrop-blur-2xl px-4 py-8 flex flex-col hidden md:flex min-h-full">
            ...
            {/* Main Content */}
            <main className="flex-1 relative w-full pt-8">
