                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <ScrollReveal className="lg:col-span-5 relative">
                            <motion.div variants={FADE_LEFT} className="relative aspect-[3/4] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                                <Image
                                    src="/teacher2.png"
                        ...
                        <ScrollReveal className="lg:col-span-7">
                            <motion.div variants={FADE_UP} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 mb-6">
                                <Trophy className="w-4 h-4 text-purple-400" />
                                <span className="text-xs font-bold uppercase tracking-widest text-purple-100">Founder & CEO</span>
                            </motion.div>

                            <motion.h2 variants={FADE_UP} id="ceo-heading" className="text-4xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight mb-6">
                                Meet{' '}
                            ...
                            <motion.p variants={FADE_UP} className="text-lg text-gray-400 leading-relaxed mb-10">
                            ...
                            {/* Stats 2x2 Grid */}
                            <motion.div variants={FADE_UP} className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                                {/* Stat 1 */}
                                <div className="border border-white/10 bg-white/5 rounded-2xl p-5 flex items-center gap-4 hover:border-purple-500/30 hover:bg-white/10 transition-colors">
                                    <div className="w-12 h-12 rounded-xl bg-purple-500/20 flex items-center justify-center shrink-0">
                                        <Trophy className="w-5 h-5 text-purple-400" />
                                    </div>
                                    <div>
                                        <div className="text-lg font-bold text-white leading-tight">15+ Years</div>
                                        <div className="text-xs text-gray-400">Education Experience</div>
                                    </div>
                                </div>
                                {/* Stat 2 */}
                                <div className="border border-white/10 bg-white/5 rounded-2xl p-5 flex items-center gap-4 hover:border-pink-500/30 hover:bg-white/10 transition-colors">
                                    <div className="w-12 h-12 rounded-xl bg-pink-500/20 flex items-center justify-center shrink-0">
                                        <Users className="w-5 h-5 text-pink-400" />
                                    </div>
                                    <div>
                                        <div className="text-lg font-bold text-white leading-tight">50,000+</div>
                                        <div className="text-xs text-gray-400">Students Mentored</div>
                                    </div>
                                </div>
                                {/* Stat 3 */}
                                <div className="border border-white/10 bg-white/5 rounded-2xl p-5 flex items-center gap-4 hover:border-blue-500/30 hover:bg-white/10 transition-colors">
                                    <div className="w-12 h-12 rounded-xl bg-blue-500/20 flex items-center justify-center shrink-0">
                                        <BookOpen className="w-5 h-5 text-blue-400" />
                                    </div>
                                    <div>
                                        <div className="text-lg font-bold text-white leading-tight">95%</div>
                                        <div className="text-xs text-gray-400">Success Rate</div>
                                    </div>
                                </div>
                                {/* Stat 4 */}
                                <div className="border border-white/10 bg-white/5 rounded-2xl p-5 flex items-center gap-4 hover:border-emerald-500/30 hover:bg-white/10 transition-colors">
                                    <div className="w-12 h-12 rounded-xl bg-emerald-500/20 flex items-center justify-center shrink-0">
                                        <ShieldCheck className="w-5 h-5 text-emerald-400" />
                                    </div>
                                    <div>
                                        <div className="text-lg font-bold text-white leading-tight">25+</div>
                            ...
                            {/* Quote Block */}
                            <motion.div variants={FADE_UP} className="bg-gray-900 border border-white/10 rounded-2xl p-6 sm:p-8 relative overflow-hidden">
                                <Quote className="w-10 h-10 text-purple-500/30 mb-4" />
                                <p className="text-sm sm:text-base text-gray-300 italic leading-relaxed mb-6 italic relative z-10">
                                ...
                                <div className="flex items-center gap-4 z-10 relative">
                                    ...
                                    <div>
                                        <div className="text-sm font-bold text-white leading-tight">Ajay Singh Rajput</div>
                                        <div className="text-xs text-gray-500">Founder & CEO</div>
                                    </div>
                                </div>
                                {/* Abstract gradient glow behind quote */}
                                <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-purple-500/10 rounded-full blur-[60px] pointer-events-none" />
                            </motion.div>
