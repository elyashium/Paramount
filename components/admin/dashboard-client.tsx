                ...
                <div className="lg:col-span-1 border border-white/10 bg-white/5 rounded-3xl overflow-hidden flex flex-col h-[500px]">
                    <div className="p-5 border-b border-white/10 flex items-center justify-between bg-black/20">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-sm font-bold text-white">Latest Alerts</h2>
                        </div>
                        <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">System Normal</span>
                    </div>
                        ...
                        <div className="space-y-1">
                            <div className="p-3 rounded-xl hover:bg-white/5 transition-colors cursor-pointer border border-transparent">
                                <div className="flex items-start justify-between mb-1">
                                    <h4 className="text-xs font-bold text-white">Dashboard Live</h4>
                                    <span className="text-[10px] text-gray-500">Just now</span>
                                </div>
                                <p className="text-[11px] text-gray-400 line-clamp-2">Admin analytics widgets connected to Supabase successfully.</p>
                            </div>
                            <div className="p-3 rounded-xl hover:bg-white/5 transition-colors cursor-pointer border border-transparent">
                                <div className="flex items-start justify-between mb-1">
